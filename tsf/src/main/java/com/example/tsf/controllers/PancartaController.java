...
@RestController
@RequestMapping("/api/pancarta")
public class PancartaController {

	@Autowired
	private IPancarta service;
	private static final Log LOG = LogFactory.getLog(PancartaController.class);
	
	private String entity = "Pancarta";
    
    @GetMapping("/{id}")
    public PancartaDto get(
    ...
    @PostMapping
    public PancartaDto save(@RequestBody PancartaDto itemDto){
    ...
    @PutMapping
    public PancartaDto update(@RequestBody PancartaDto itemDto){
