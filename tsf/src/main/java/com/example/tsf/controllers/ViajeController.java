...
public class ViajeController {
	...
	@Autowired
	private IViaje service;
	private static final Log LOG = LogFactory.getLog(ViajeController.class);
	
	private String entity = "Viaje";
    ...
    @PostMapping
    public ViajeDto save(@RequestBody ViajeDto itemDto){
    ...
    @PutMapping
    public ViajeDto update(@RequestBody ViajeDto itemDto){
