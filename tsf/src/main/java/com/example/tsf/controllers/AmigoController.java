...
public class AmigoController {
	...
	@Autowired
	private IAmigo service;
	private static final Log LOG = LogFactory.getLog(AmigoController.class);
	
	private String entity = "Amigo";
    ...
    @PostMapping
    public AmigoDto save(@RequestBody AmigoDto itemDto){
    ...
    @PutMapping
    public AmigoDto update(@RequestBody AmigoDto itemDto){
