...
@RestController
@RequestMapping("/api/sociobandera")
public class SocioBanderaController {

	@Autowired
	private ISocioBandera service;
	private static final Log LOG = LogFactory.getLog(SocioBanderaController.class);
	
	private String entity = "SocioBandera";
    
    @GetMapping("/{id}")
    public SocioBanderaDto get(
    ...
    @PostMapping
    public SocioBanderaDto save(@RequestBody SocioBanderaDto itemDto){
    ...
    @PutMapping
    public SocioBanderaDto update(@RequestBody SocioBanderaDto itemDto){
